...
docker pull wsams/gifverse:1.0.6
docker run -p 5000:5000 wsams/gifverse:1.0.6
...
services:
  gifverse:
    image: wsams/gifverse:1.0.6  # Pin to specific version
    ports:
      - "5000:5000"
    volumes:
...
- **Push to Docker Hub** with multiple tags:
  ...
  - `wsams/gifverse:1.0.6` (specific version)
